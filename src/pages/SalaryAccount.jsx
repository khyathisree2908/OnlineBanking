...
export default function SalaryAccount() {
  ...
  const handleCompare = () => navigate('/compare-accounts');
  const handleDownload = () => {
    const link = document.createElement('a');
    link.href = '/brochures/salary-account-brochure.pdf';
    link.download = 'JKL-Salary-Account-Brochure.pdf';
  ...
  return (
    <div>
      ...
      <BtnRow>
        ...
        <ActionBtn onClick={handleCompare}>Compare Accounts</ActionBtn>
        <ActionBtn onClick={handleDownload}>Download Brochure</ActionBtn>
      </BtnRow>
      {showModal && (
        <ModalOverlay>
          <ModalBox>
            <h2>Open Salary Account</h2>
            <p>Thank you for your interest! Our representative will contact you soon to help you open your Salary Account at JKL Bank.</p>
